...
export default function Benefit() {
  ...
  return (
    <div className="min-h-screen mt-[90px] p-2">
      <div className="max-w-7xl mx-auto">
        ...
        {paymentsData && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 w-full">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 w-full">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-600 text-sm font-medium">Sotuv soni</p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8 border border-gray-200">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Sotuv dinamikasi</h2>
